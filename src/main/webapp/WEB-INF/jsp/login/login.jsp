	...
	<header class="masthead" id="login">
		<div class="container">
			...
			<form method="post" action="<c:url value="login/autenticar"/>">
					...
					<div class="col-md-12 align-self-center text-center">
						<div class="form-group input-login mx-auto">
							<input class="form-control" id="email" type="email" name="email"
								value="${email}" placeholder="Email *" required="required"
								data-validation-required-message="Please enter your email address." />
							<p class="help-block text-danger"></p>
						</div>
						<div class="form-group mb-md-0 input-login mx-auto">
							<input name="senha" class="form-control" id="password"
								type="password" value="${senha}" placeholder="Senha *"
				...
				<button type="submit"
					class="btn btn-primary btn-xl text-uppercase js-scroll-trigger">Login</button>
			</form>
		</div>
	</header>
	<!-- beneficios-->
		...
		<div class="container">
			...
			<div class="row text-center">
				...
				<div class="col-md-4">
					...
					<p class="text-muted">Consulte sua compra na web por qualquer
						dispositivo. Celular, Tablet ou Computador!</p>
				</div>
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i
						class="fas fa-circle fa-stack-2x text-primary"></i> <i
